...
public class SearchSteps {
    ...
    public void heSearchesForProductFromTheDropDownMenu() throws Throwable {
        mainSearchPage.selectClothingAndAccessory();
        mainSearchPage.selectBeltAndBraces();

    }

    @Then("^the search result should be displayed$")
    public void theSearchResultShouldBeDisplayed() throws Throwable {
        // Write code here that turns the phrase above into concrete actions
        assertThat(mainSearchPage.getTitleName().equals("Belts & Braces"));
    }


    @When("^he clicks jewellery icon$")
    public void heClicksJewelleryIcon() throws Throwable {
        // Write code here that turns the phrase above into concrete actions
        mainSearchPage.clickJewelleryIcon();
    }

    @Then("^the jewellery results should be displayed$")
    public void theJewelleryResultsShouldBeDisplayed() throws Throwable {
        // Write code here that turns the phrase above into concrete actions
        assertThat(mainSearchPage.getTitleName().equals("Jewellery"));
    }
